...
newman run $collection_url --environment $environment_url --export-environment newenv.json -r htmlextra --reporter-htmlextra-logs 
# -r htmlextra --reporter-htmlextra-export report-"$4".html
