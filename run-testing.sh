...
newman run $collection_url --environment $environment_url --export-environment newenv.json --disable-unicode -r htmlextra --reporter-htmlextra-export report-"$4".html
