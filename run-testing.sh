...
filename = "report-$5.html"
newman run $collection_url --environment $environment_url --export-environment newenv.json -r htmlextra --reporter-htmlextra-export $filename
